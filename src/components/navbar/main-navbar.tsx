...
export default function Navbar() {
  return (
    <div className='min-w-screen flex justify-center item-center z-50 dark'>
      <motion.div className="w-[24rem] sm:w-[30rem] flex flex-row item-center justify-center text-lg font-medium bg-darkb bg-opacity-80 rounded-xl fixed"
    initial={{ opacity: 0, y: -150 }}
        ...
        <div className='relative group w-[24rem] sm:w-[30rem]'>
            ...
            <div className=' w-screen  flex  flex-row justify-evenly '>
              <div className='flex text-center justify-center items-center w-[112px] hover:bg-darkb2 rounded-lg text-gray-300 hover:text-gray-50'> 
                <Link href="/#Hjem"  >Hjem</Link> 
                  ...
                  <div className="flex text-center justify-center items-center bg-transparent"> <DropdownNavbar/> </div>
