...
export default function Intro() {
  ...
  return (
    <section 
      id="intro" >
        <div className="flex flex-col items-center justify-center bg-dark overflow-hidden">
            ...
            animate={controls}>
                <Tabs defaultValue="utvikling" className="w-[400px] m-4 mt-12 justify-center item-center">
                    ...
                    <div className='flex justify-center w-[400px] mt-10'>
                    <TabsContent value="utvikling" >
                        ...
                        <div className='absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-lg blur opacity-70 '></div>
                            <div className='relative flex justify-center p-2 border-shadow rounded-xl bg-darkb flex-col text-center w-[400px] items-center'>
                                <h3 className='text-xl font-bold mb-4 mt-2'>Utvikling</h3>
                                <p className=' px-2 text-center'>I IT-faget knyttes Utvikling til programmeringspråk og rammeverk som brukes til å lage et produkt. <p></p>
                    ...
                    <TabsContent value="brukerstøtte" >
                        ...
                        <div className='absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-lg blur opacity-70 '></div>
                            <div className='relative flex justify-center p-2 border-shadow rounded-xl bg-darkb flex-col text-center w-[400px] items-center'>
                                ...
                                <p className=' px-2 text-center'>Brukerstøtte handler om kommunikasjon og veiledning, hvordan man kan veilede, formulere og ta i bruk nyttige verktøy til trygg og sikker utvikling. <p></p>
                    ...
                    <TabsContent value="drift" >
                        ...
                        <div className='absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-lg blur opacity-70 '></div>
                            <div className='relative flex justify-center p-2 border-shadow rounded-xl bg-darkb flex-col text-center w-[400px] items-center'>
                                ...
                                <p className=' px-2 text-center'>I drift-faget er nettverk, databaser og sikkerhet sentrale elementer. Det er viktig å ha et trygt produkt med riktig sikkerhet. <p></p>
                    ...
                    {/* <TabsContent value="brukerstøtte" className='flex justify-center p-2 border-shadow rounded-xl bg-darkb flex-col text-center w-full'>
                        <h3 className='text-xl font-bold mb-4 mt-2'>Utvikling</h3>
                        <p className='h-32'>I IT-faget knyttes Utvikling til lorem ipsum</p>
                    </TabsContent>
                    <TabsContent value="drift" className='flex justify-center p-2 border-shadow rounded-xl bg-darkb flex-col text-center w-full'>
                    <h3 className='text-xl font-bold mb-4 mt-2'>Utvikling</h3>
                        <p className='h-32'>I IT-faget knyttes Utvikling til lorem ipsum</p>
                    </TabsContent>  */}
                    </div>
